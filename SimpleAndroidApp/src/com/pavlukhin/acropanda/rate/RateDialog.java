...
public class RateDialog extends Dialog {
    ...
    private void prepareButton(Button btn, int resId) {
        ...
        setLeftIcon(btn, resId);
    }

    private void setLeftIcon(Button btn, int resId) {
        ...
        float scale = iconHeight / d.getIntrinsicHeight();
        d.setBounds(
                margin,
                0,
                margin + (int) (scale * d.getIntrinsicWidth()),
                (int) (scale * d.getIntrinsicHeight()));
