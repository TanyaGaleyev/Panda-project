...
/c/OtherProgramms/Android/android-studio/sdk/build-tools/19.1.0/zipalign.exe -v 4 "${build_dir}/SimpleAndroidApp-release-unsigned.apk" "${build_dir}/AcroPanda.apk"
